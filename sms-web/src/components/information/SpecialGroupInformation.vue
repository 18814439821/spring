<template>
  <div>
    <div style="margin-bottom:5px">
      ...
      <el-radio v-model="specialGroup" label="Y" border size="small" style="margin-left: 10px;margin-top: 5px">特殊群体</el-radio>
      <el-radio v-model="specialGroup" label="N" border size="small" style="margin-left: 0px;margin-top: 5px">非特殊群体</el-radio>
    ...
    <el-main style="height: 100%; padding:0px; padding-bottom: 5px">
      ...
      >
        ...
        <el-table-column prop="specialGroup" label="特殊群体" >
          <template slot-scope="scope">
            <el-tag
                :type="scope.row.specialGroup === 'null'||scope.row.specialGroup === '' ? 'danger' : 'success'"
                disable-transitions>{{scope.row.specialGroup === 'null' ? '否' : '是'}}</el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form"  label-width="150px">
        ...
        <el-form-item label="特殊群体缘由" prop="specialGroup">
          <el-input
              type="textarea"
              autosize
              placeholder="请输入内容"
              v-model="form.specialGroup"
...
export default {
  ...
  methods:{
    ...
    doMod(){
      if (this.form.specialGroup===""){
        this.form.specialGroup="null";
      }
    ...
    loadPost(){
      this.$axios.post(this.$httpUrl+'/stu/resultSP',{
        pageSize:this.pageSize,
        pageNum:this.pageNum,
        param:{
          name:this.name,
          isvalid:this.isvalid,
          specialGroup: this.specialGroup,
          roleId:'2',
        }
