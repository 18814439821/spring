<template>
  <div>
    <div style="margin-bottom:5px">
      ...
      <el-radio v-model="emergencySituation" label="Y" border size="small" style="margin-left: 10px;margin-top: 5px">有突发状况</el-radio>
      <el-radio v-model="emergencySituation" label="N" border size="small" style="margin-left: 0px;margin-top: 5px">无突发状况</el-radio>
    ...
    <el-main style="height: 100%; padding:0px; padding-bottom: 5px">
      ...
      >
        ...
        <el-table-column prop="emergencySituation" label="突发状况" >
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form"  label-width="150px">
        <el-form-item label="名字" prop="name">
          <el-input v-model="form.name"  :disabled="true" style="width: 100px"></el-input>
        </el-form-item>
        <el-form-item label="紧急情况" prop="emergencySituation">
          <el-input
              type="textarea"
              autosize
              placeholder="请输入内容"
              v-model="form.emergencySituation"
  ...
  methods:{
    ...
    mod(row){
      ...
      this.$nextTick(()=>{
        ...
        this.form.no=row.no;
        this.form.emergencySituation=row.emergencySituation;
        this.centerDialogVisible=true;
      })
    },
    doMod(){
      if (this.form.emergencySituation===""){
        this.form.emergencySituation="null";
      }
    ...
    loadPost(){
      this.$axios.post(this.$httpUrl+'/stu/resultES',{
        pageSize:this.pageSize,
        pageNum:this.pageNum,
        param:{
          name:this.name,
          isvalid:this.isvalid,
          emergencySituation: this.emergencySituation,
          roleId:'2',
        }
